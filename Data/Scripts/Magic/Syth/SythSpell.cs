	...
	public abstract class SythSpell : Spell
	{
		...
		public static string SpellInfo( int spellID, int slice )
		{
			...
			if ( spellID == 270 ){ name = "Psychokinesis"; icon="1038"; crystal = "6"; skill = "10"; mana = "5"; mantra = "Dzwol Hyal"; map = "Sosaria"; dungeon = "the Fires of Hell"; world = "Land of Sosaria"; syth = "Prince Myrhal of Rax"; scroll = "SythDatacron01"; 
				...
				describe = "The Syth can reach out with their hatred and anger, psychically gripping a foe for 5-20 points of damage every few seconds. This effect lasts for 2-75 seconds. A Syth skill in sword and tactics, aswell as their accumulated hatred and anger will increase the effectiveness of this power."; }
				...
				describe = "This power allows the Syth to create a projection of themselves that can distract foes. This projection contains physical attributes as the psychic energy of the Syth can maintain the illusion for up to about 3 minutes, depending on how powerful they are."; }
